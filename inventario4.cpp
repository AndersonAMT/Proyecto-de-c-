...
void guardarEnArchivo(const string& nombreArchivo, const vector<Categorias>& categorias);
void cargarDesdeArchivo(const string& nombreArchivo, vector<Categorias>& categorias);
int main(){
    vector <Categorias> categoria;
    int opcion;
    fstream archivo("Inventario.txt");
    cargarDesdeArchivo("inventario.txt", categoria);
    ...
    do{
        ...
        case 0:
            ...
            guardarEnArchivo("inventario.txt", categoria);
            break;
...
void guardarEnArchivo(const string& nombreArchivo, const vector<Categorias>& categorias) {
    ...
    for (const auto& categoria : categorias) {
        ...
        for (const auto& alimento : categoria.alimentos) {
            archivo << alimento.nombre << " " << alimento.cantidad << "\n";
        }
